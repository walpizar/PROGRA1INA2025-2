...
namespace UI
{
    public class frmDevolucion : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblTitulo.Text = "Registrar Devoluci�n";
            // 
            // lblActivo
            // 
            ...
            lblFecha.TabIndex = 3;
            lblFecha.Text = "Fecha devoluci�n:";
            // 
            // dtpFecha
            // 
        ...
        private void frmDevolucion_Load(object sender, EventArgs e)
        {
            ...
            {
                this.lblTitulo.Text = "Modificar Devoluci�n";
                this.Text = "Modificar Devoluci�n";
            ...
            {
                this.lblTitulo.Text = "Registrar Devoluci�n";
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (devolucionSelected == null)
                {
                    ...
                    MessageBox.Show("Devoluci�n registrada correctamente.");
                }
                else
                {
                    _devolucionService.modificar(devolucion);
                    MessageBox.Show("Devoluci�n modificada correctamente.");
                }
            ...
            {
                MessageBox.Show("Error al procesar la devoluci�n. Contacte al administrador.");
            }
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                if (devolucionSelected == null)
                {
                    MessageBox.Show("No hay una devoluci�n seleccionada.");
                    return;
                }

                var resp = MessageBox.Show("�Est� seguro que desea eliminar la devoluci�n?", "Confirmaci�n",
                    MessageBoxButtons.YesNo, MessageBoxIcon.Question);

                if (resp == DialogResult.Yes)
                {
                    _devolucionService.eliminar(devolucionSelected.idDevolucion);
                    MessageBox.Show("Devoluci�n eliminada correctamente.");
                    this.Close();
                }
            }
            catch
            {
                MessageBox.Show("Error al eliminar la devoluci�n.");
            }
        }
