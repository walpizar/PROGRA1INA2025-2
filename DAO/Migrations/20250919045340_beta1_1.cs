...
{
    /// <inheritdoc />
    public partial class beta1_1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    usuarioModificacion = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    fechaModificacion = table.Column<DateTime>(type: "datetime2", nullable: true),
                    razonModifica = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbDonaciones", x => x.idDonacion);
                    table.ForeignKey(
                        name: "FK_tbDonaciones_tbDonantes_donanteId_donanteTipoId",
                        columns: x => new { x.donanteId, x.donanteTipoId },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fechaModificacion = table.Column<DateTime>(type: "datetime2", nullable: true),
                    razonModifica = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    DonacionidDonacion = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tbDonacionesActivos_tbDonaciones_DonacionidDonacion",
                        column: x => x.DonacionidDonacion,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbDonaciones_donanteId_donanteTipoId",
                table: "tbDonaciones",
                columns: new[] { "donanteId", "donanteTipoId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbDonacionesActivos_DonacionidDonacion",
                table: "tbDonacionesActivos",
                column: "DonacionidDonacion");
