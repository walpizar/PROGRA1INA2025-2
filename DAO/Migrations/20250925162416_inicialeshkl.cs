...
{
    /// <inheritdoc />
    public partial class inicialeshkl : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idTipoDonacion = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    nombreTipoDonacion = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    descripcion = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    requiereMonto = table.Column<bool>(type: "bit", nullable: false),
                    requiereTipoTransaccion = table.Column<bool>(type: "bit", nullable: false),
                    requiereFrecuencia = table.Column<bool>(type: "bit", nullable: false),
                    requiereTipoMoneda = table.Column<bool>(type: "bit", nullable: false),
                    estado = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    razonInactivo = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    razonModifica = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbTipoDonacion", x => x.idTipoDonacion);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tipoDonante = table.Column<int>(type: "int", nullable: false),
                    estado = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    razonInactivo = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    razonModifica = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbDonante", x => new { x.personaId, x.personaTipoId });
                    table.ForeignKey(
                        name: "FK_tbDonante_tbPersonas_personaId_personaTipoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idDonacion = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    donanteId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    donanteTipoId = table.Column<int>(type: "int", nullable: false),
                    idTipoDonacion = table.Column<int>(type: "int", nullable: false),
                    ...
                    tipoMoneda = table.Column<int>(type: "int", nullable: true),
                    fechaProximaDonacion = table.Column<DateTime>(type: "datetime2", nullable: true),
                    usuarioCreacion = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    fechaCreacion = table.Column<DateTime>(type: "datetime2", nullable: false),
                    usuarioModificacion = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    fechaModificacion = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbDonacion", x => x.idDonacion);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tbDonacion_tbTipoDonacion_idTipoDonacion",
                        column: x => x.idTipoDonacion,
                        principalTable: "tbTipoDonacion",
                        principalColumn: "idTipoDonacion",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    clsDonacionidDonacion = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tbActivos_tbDonacion_clsDonacionidDonacion",
                        column: x => x.clsDonacionidDonacion,
                        principalTable: "tbDonacion",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbActivos_clsDonacionidDonacion",
                table: "tbActivos",
                column: "clsDonacionidDonacion");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbDonacion_idTipoDonacion",
                table: "tbDonacion",
                column: "idTipoDonacion");
