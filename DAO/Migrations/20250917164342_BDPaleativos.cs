...
{
    /// <inheritdoc />
    public partial class BDPaleativos : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    personaId_ = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbUsuarios", x => x.personaId_);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbRolPermiso", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    idDonante = table.Column<string>(type: "nvarchar(20)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tbDonaciones_tbDonantes_idDonante_idDonacion",
                        columns: x => new { x.idDonante, x.idDonacion },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbDonaciones_idDonante_idDonacion",
                table: "tbDonaciones",
                columns: new[] { "idDonante", "idDonacion" });
