        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    montoGasto = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    ...
                    queSeCompro = table.Column<string>(type: "NVARCHAR(300)", maxLength: 300, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbGastos", x => x.idGasto);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    tipoId = table.Column<int>(type: "int", maxLength: 20, nullable: false),
